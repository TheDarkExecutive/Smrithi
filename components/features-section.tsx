            ...
            <div className="bg-zinc-50 rounded-3xl p-8 lg:p-12">
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-muted-foreground">Family connected</p>
                    <p className="text-foreground font-medium">Ravi notified about today&apos;s activity</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-normal mb-6 text-balance font-serif">
                More than reminders. A true companion.
              </h2>
              <p className="text-muted-foreground leading-relaxed text-lg">
                Smrithi does not just send notifications. It has conversations, learns routines, and provides genuine companionship through voice interaction.
              </p>
            </motion.div>
            ...
            <div className="grid sm:grid-cols-1 gap-4">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="flex items-center p-3 rounded-xl hover:bg-zinc-50 transition-colors duration-300 gap-3 py-2"
                >

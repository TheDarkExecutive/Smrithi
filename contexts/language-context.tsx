...
export const translations: Translations = {
  ...
  "features.raviNotified": { en: "Ravi notified about today's activity", hi: "रवि को आज की गतिविधि के बारे में सूचित किया गया", kn: "ಇಂದಿನ ಚಟುವಟಿಕೆಯ ಬಗ್ಗೆ ರವಿಗೆ ತಿಳಿಸಲಾಗಿದೆ", te: "ఈ రోజు యాక్టివిటీ గురించి రవికి తెలియజేయబడింది", ta: "இன்றைய செயல்பாடு பற்றி ரவிக்கு தெரிவிக்கப்பட்டது" },
